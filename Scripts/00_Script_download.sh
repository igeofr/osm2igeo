...
rm "11_ILE_DE_FRANCE.pbf"
curl --limit-rate 100K https://download.geofabrik.de/europe/france/ile-de-france-latest.osm.pbf > "11_ILE_DE_FRANCE.pbf"
...
rm "31_NORD_PAS_DE_CALAIS.pbf"
curl --limit-rate 100K https://download.geofabrik.de/europe/france/nord-pas-de-calais-latest.osm.pbf > "31_NORD_PAS_DE_CALAIS.pbf"
