...
do
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        #Couche DEPARTEMENT
        sh Scripts/H_OSM_ADMINISTRATIF/DEPARTEMENT_BENIN.sh > data_temp/H_OSM_ADMINISTRATIF/DEPARTEMENT.txt 2>&1
        #Couche CHEF LIEU
