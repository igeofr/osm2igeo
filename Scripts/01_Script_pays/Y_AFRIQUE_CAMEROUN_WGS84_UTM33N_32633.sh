...
do
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        #Couche DEPARTEMENT
        sh Scripts/H_OSM_ADMINISTRATIF/REGION_CAMEROUN.sh > data_temp/H_OSM_ADMINISTRATIF/REGION.txt 2>&1
        #Couche CHEF LIEU
