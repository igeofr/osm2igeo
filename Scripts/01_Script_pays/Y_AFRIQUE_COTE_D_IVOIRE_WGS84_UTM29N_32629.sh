...
do
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        #Couche DISTRICT
        sh Scripts/H_OSM_ADMINISTRATIF/DISTRICT_COTE_D_IVOIRE.sh > data_temp/H_OSM_ADMINISTRATIF/DISTRICT.txt 2>&1
        #Couche CHEF LIEU
