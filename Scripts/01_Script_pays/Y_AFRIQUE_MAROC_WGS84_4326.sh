...
do
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        #Couche REGION
        sh Scripts/H_OSM_ADMINISTRATIF/REGION_MAROC.sh > data_temp/H_OSM_ADMINISTRATIF/REGION.txt 2>&1
        #Couche COMMUNE
        sh Scripts/H_OSM_ADMINISTRATIF/COMMUNE_MAROC.sh > data_temp/H_OSM_ADMINISTRATIF/COMMUNE.txt 2>&1
        #Couche CHEF LIEU
