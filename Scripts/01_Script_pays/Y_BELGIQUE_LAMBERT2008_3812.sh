...
do
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        #Couche PROVINCE
        sh Scripts/H_OSM_ADMINISTRATIF/PROVINCE_BELGIQUE.sh > data_temp/H_OSM_ADMINISTRATIF/PROVINCE.txt 2>&1
        #Couche COMMUNE
        sh Scripts/H_OSM_ADMINISTRATIF/COMMUNE_BELGIQUE.sh > data_temp/H_OSM_ADMINISTRATIF/COMMUNE.txt 2>&1
        #Couche CHEF LIEU
        sh Scripts/H_OSM_ADMINISTRATIF/CHEF_LIEU_BELGIQUE.sh > data_temp/H_OSM_ADMINISTRATIF/CHEF_LIEU.txt 2>&1
    #----------------------------------------------------------------------------------
    #I_OSM_ZONE_ACTIVITE
