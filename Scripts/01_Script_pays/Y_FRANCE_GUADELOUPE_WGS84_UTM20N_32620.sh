...
for file in GUADELOUPE.pbf

do
    #Variables
    export OUT_EPSG=32620
    ...
    mkdir data_temp/H_OSM_ADMINISTRATIF
        ...
        sh Scripts/H_OSM_ADMINISTRATIF/ARRONDISSEMENT_FRANCE.sh > data_temp/H_OSM_ADMINISTRATIF/ARRONDISSEMENT.txt 2>&1
        #Couche COMMUNE
        sh Scripts/H_OSM_ADMINISTRATIF/COMMUNE_FRANCE.sh > data_temp/H_OSM_ADMINISTRATIF/COMMUNE.txt 2>&1
        #Couche CHEF LIEU
        sh Scripts/H_OSM_ADMINISTRATIF/CHEF_LIEU_FRANCE.sh > data_temp/H_OSM_ADMINISTRATIF/CHEF_LIEU.txt 2>&1
    #----------------------------------------------------------------------------------
    #I_OSM_ZONE_ACTIVITE
    ...
    cp X_PROJET_V3_${file%%.*}'_SHP_'$OUT_EPSG.qgs.qgz data_out/$PAYS/$DATE'_'${file%%.*}'_SHP'$NZ/X_PROJET_V3.qgs.qgz
    ...
    cp X_PROJET_V3_${file%%.*}'_GEOPACKAGE_'$OUT_EPSG.qgs.qgz data_out/$PAYS/$DATE'_'${file%%.*}'_GEOPACKAGE'$NZ/X_PROJET_V3.qgs.qgz
