...
then
  ...
  ( cat "./scripts_V3/A_OSM_RESEAU_ROUTIER/TOPONYME_COMMUNICATION_create.sql" ; cat "./data_temp/$PAYS/$OUT_EPSG/A_OSM_RESEAU_ROUTIER/TOPONYME_COMMUNICATION/"*.sql) > $file
fi
