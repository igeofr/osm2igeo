...
echo "Debut : F_OSM_VEGETATION > ZONE_VEGETATION_vigne.shp"
$LINK_OGR -progress -s_srs EPSG:4326 -t_srs EPSG:$OUT_EPSG -f 'ESRI Shapefile' 'data_temp/'$PAYS/$OUT_EPSG'/F_OSM_VEGETATION/ZONE_VEGETATION/ZONE_VEGETATION_vigne.shp' -dialect SQLITE -sql "SELECT * FROM (
------------------------------------------------------------------------------------------------------------
------------------------------------ Vigne -----------------------------------------------------------------
------------------------------------------------------------------------------------------------------------
SELECT
...
echo "Fin : F_OSM_VEGETATION > ZONE_VEGETATION_vigne.shp"
