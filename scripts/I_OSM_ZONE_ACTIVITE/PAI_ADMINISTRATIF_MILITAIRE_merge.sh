...
then
  ...
  ( cat "./scripts_V3/I_OSM_ZONE_ACTIVITE/PAI_ADMINISTRATIF_MILITAIRE_create.sql" ; cat "./data_temp/$PAYS/$OUT_EPSG/I_OSM_ZONE_ACTIVITE/PAI_ADMINISTRATIF_MILITAIRE/"*.sql) > $file
fi
