...
then
  ...
  ( cat "./scripts/I_OSM_ZONE_ACTIVITE/PAI_INDUSTRIEL_COMMERCIAL_create.sql" ; cat "./data_temp/$PAYS/$OUT_EPSG/I_OSM_ZONE_ACTIVITE/PAI_INDUSTRIEL_COMMERCIAL/"*.sql) > $file
fi
