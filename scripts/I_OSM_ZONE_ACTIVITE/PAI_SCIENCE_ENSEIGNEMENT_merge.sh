...
then
  ...
  ( cat "./scripts_V3/I_OSM_ZONE_ACTIVITE/PAI_SCIENCE_ENSEIGNEMENT_create.sql" ; cat "./data_temp/$PAYS/$OUT_EPSG/I_OSM_ZONE_ACTIVITE/PAI_SCIENCE_ENSEIGNEMENT/"*.sql) > $file
fi
