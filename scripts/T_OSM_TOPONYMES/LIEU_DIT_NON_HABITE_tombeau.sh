...
echo "Debut : T_OSM_TOPONYMES > LIEU_DIT_NON_HABITE_tombeau.shp"
$LINK_OGR -progress -s_srs EPSG:4326 -t_srs EPSG:$OUT_EPSG -f 'ESRI Shapefile' 'data_temp/'$PAYS/$OUT_EPSG'/T_OSM_TOPONYMES/LIEU_DIT_NON_HABITE/LIEU_DIT_NON_HABITE_tombeau.shp' -dialect SQLITE -sql "SELECT * FROM (
------------------------------------------------------------------------------------------------------------
------------------------------------ Tombeau ---------------------------------------------------------------
------------------------------------------------------------------------------------------------------------
SELECT
...
echo "Fin : T_OSM_TOPONYMES > LIEU_DIT_NON_HABITE_tombeau.shp"
